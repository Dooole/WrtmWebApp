...
namespace WrtmWebApp.Controllers
{
    public class LogController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Datetime,Severity,Message")] Log log)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Datetime,Severity,Message")] Log log)
        {
            if (ModelState.IsValid)
            {
